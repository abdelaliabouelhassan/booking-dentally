<template>
  <div class=" pt-5 space-y-8">
    <h1 class="uppercase font-semibold" v-if="index == 0">Next Available Slots</h1>
        ...
        <li>
          <div class=" grid grid-cols-3 gap-5" >
            <span
             ...
             v-for="(item,index,key) in dates" :key="key"
              ...
              "
              :class="{'border-theme-gold':store.availableTime.start_time == item.start_time,'border-theme-gray-light':store.availableTime.start_time != item.start_time}"
...
export default {
  ...
  methods:{
    ...
    formateDate(){
      ...
      let dayOfWeekString = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
      return dayOfWeekString[dayOfWeek] + ", " + day + "th " + month;
    },
    formateTime(time){     
